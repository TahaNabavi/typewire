    ...
    <div style={{ ...styles.setSection, overflowY: 'auto', width: '100%' }}>
      <div style={styles.setRow}>
        <span style={styles.setLabel}>
          ...
          <span style={styles.setHint}>
            auto follows the host's color scheme
          </span>
        </span>
        <Segmented
      ...
      <div style={styles.setRow}>
        <span style={styles.setLabel}>
          <span>Sound</span>
          <span style={styles.setHint}>
            a blip on new traffic, a buzz on error
          </span>
        </span>
        <Toggle
      ...
      <p style={{ ...styles.setHint, marginTop: 12 }}>
        ...
        — every color above is an inline value, and only the row animations use
        an injected <code>@keyframes</code> block.
      </p>
    </div>
  )
}
