...
"@tahanabavi/typefetch-encryption": minor
"@tahanabavi/typefetch-graphql": minor
"@tahanabavi/typefetch-grpc": minor
"@tahanabavi/typewire-cli": minor
---

Pluggable transports, and a core with zero runtime dependencies.
...
- A request input that failed its own `request` schema escaped as a raw
  ...
  to instrumentation — while a bad *response* one line later did all four. Both
