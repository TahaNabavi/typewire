        ...
        {sent ? (
          <Panel className="items-center justify-center py-12 text-center">
            ...
            <p className="mx-auto mt-2 max-w-xs text-sm text-muted-foreground">
              We opened a prefilled issue in a new tab — review it and submit
              there.
            </p>
            <Button
              variant="outline"
          ...
          <Panel>
            <div className="grid grid-cols-1 gap-4 pb-4 sm:grid-cols-2">
              <label className="block">
                ...
                <Select
                  value={pkg}
                  onValueChange={(value) => setPkg(String(value))}
                >
            ...
            <p className="mt-2 font-mono text-[11px] text-dim">
              → opens a prefilled issue on github.com/{site.repo.owner}/
              {site.repo.name}
            </p>
          </Panel>
        )}
