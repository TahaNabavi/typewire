      ...
      <Panel className="enter-up mb-5">
        <div className="flex flex-wrap items-start justify-between gap-4 pb-5">
          <div className="max-w-xl">
            <h3 className="text-lg font-bold text-fg">Transport-agnostic devtools</h3>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              REST, GraphQL, gRPC and WebSocket traffic land in one live timeline — each row badged
              by the wire it used, each failure named by the same taxonomy. Hover a wire to isolate
              it.
            </p>
          </div>
        </div>
