...
const url = (process.env.NEXT_PUBLIC_SITE_URL ?? "https://typewire.tahanabavi.ir").replace(
  /\/+$/,
  "",
);
...
export const footerNav = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Contributing", href: `${site.repo.url}/blob/main/CONTRIBUTING.md` },
      { label: "Code of Conduct", href: `${site.repo.url}/blob/main/CODE_OF_CONDUCT.md` },
    ],
  },
  {
    title: "Resources",
    links: [
      { label: "Architecture", href: `${site.repo.url}/blob/main/docs/ARCHITECTURE.md` },
