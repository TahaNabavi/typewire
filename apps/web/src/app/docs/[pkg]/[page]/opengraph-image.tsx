...
export default async function Image({
  ...
  return ogImage({
    eyebrow: pkg !== null && pkg !== undefined ? pkg.short : '',
    title: page !== null && page !== undefined ? page.title : '',
    // Two lines at the card's body size is about 120 characters; past that the
    // description pushes the chips off the bottom edge.
    description:
      (excerpt(page !== null && page !== undefined ? page.markdown : '', 120) ??
        (pkg !== null && pkg !== undefined ? pkg.description : '')) ||
      '',
    accent: ACCENT.blue,
    kicker:
      pkg !== null &&
      ...
      pkg.docs !== null &&
      pkg.docs !== undefined
        ? `docs · v${pkg.docs.documentsVersion}`
        : 'docs',
